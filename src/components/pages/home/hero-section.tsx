...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-[60vh] md:h-[90vh] w-full flex items-center justify-center text-white">
      {heroImage && (
        <Image
      ...
      <div className="relative z-10 text-center px-4 flex flex-col items-center mt-20">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-base md:text-lg text-neutral-200">
